...
UPDATE_CHNL = os.environ.get("UPDATE_CHNL","af_t3m")
OWNER_USERNAME = os.environ.get("OWNER_USERNAME","@AF_Team_Owner")
SUPPORT_GRP = os.environ.get("SUPPORT_GRP","@af_t3m_chat")
...
SOURCE = 'https://github.com/AFTeam-Owner/BRANDEDCHATBOT'
x=["❤️","🎉","✨","🪸","🎉","🎈","🎯"]
g=choice(x)
...
async def restart(client, m: Message):
        ...
        await accha.edit("🦋𝗡𝗢𝗪 𝗖𝗢𝗠𝗘 𝗛𝗘𝗥𝗘 👉 @af_t3m_chat  , @af_t3m 𝗔𝗡𝗗 𝗠𝗔𝗞𝗘 𝗬𝗢𝗨𝗥 𝗚𝗜𝗥𝗟𝗙𝗥𝗜𝗡𝗗 🥀💋 𝗜𝗙 𝗬𝗢 𝗛𝗔𝗩𝗘 𝗔 𝗚𝗜𝗥𝗟𝗙𝗜𝗘𝗡𝗗  😘 𝗧𝗛𝗘𝗡 𝗬𝗢𝗨 𝗪𝗜𝗟𝗟 𝗚𝗜𝗙𝗧 🙊 𝗧𝗢 𝗠𝗬 𝗢𝗪𝗡𝗘𝗥 @AF_Team_Owner ❤️")
